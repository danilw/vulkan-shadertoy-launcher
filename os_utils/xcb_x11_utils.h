...
static void gen_key_map(xcb_connection_t* connection){
    ...
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_B;
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_C);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_C;
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_D);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_D;
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_E);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_E;
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_F);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_F;
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_G);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_G;
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_H);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_H;
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_I);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_I;
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_J);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_J;
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_K);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_K;
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_L);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_L;
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_M);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_M;
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_N);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_N;
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_O);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_O;
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_P);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_P;
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_Q);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_Q;
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_R);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_R;
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_S);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_S;
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_T);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_T;
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_U);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_U;
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_V);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_V;
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_W);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_W;
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_X);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_X;
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_Y);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_Y;
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_Z);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_Z;
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_space);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_Space;
    
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_0);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_0;
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_1);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_1;
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_2);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_2;
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_3);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_3;
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_4);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_4;
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_5);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_5;
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_6);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_6;
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_7);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_7;
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_8);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_8;
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_9);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_9;
    
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_Escape);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_Escape;
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_Control_L);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_Ctrl;
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_Shift_L);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_Shift;
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_Alt_L);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_Alt;
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_Super_L);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_LeftWindow;
    ...
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_RightWindows;
    
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_BackSpace);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_Backspace;
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_Tab);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_Tab;
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_Return);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_Enter;
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_Pause);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_Pause;
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_Caps_Lock);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_Caps;
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_Page_Up);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_PageUp;
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_Page_Down);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_PageDown;
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_End);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_End;
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_Home);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_Home;
    
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_Left);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_LeftArrow;
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_Up);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_UpArrow;
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_Right);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_RightArrow;
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_Down);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_DownArrow;
    
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_Insert);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_Insert;
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_Delete);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_Delete;
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_Select);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_Select;
    
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_KP_0);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_Numpad0;
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_KP_1);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_Numpad1;
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_KP_2);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_Numpad2;
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_KP_3);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_Numpad3;
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_KP_4);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_Numpad4;
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_KP_5);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_Numpad5;
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_KP_6);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_Numpad6;
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_KP_7);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_Numpad7;
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_KP_8);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_Numpad8;
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_KP_9);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_Numpad9;
    ...
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_npx7;
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_KP_Left);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_npx4;
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_KP_Up);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_npx8;
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_KP_Right);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_npx6;
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_KP_Down);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_npx2;
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_KP_Page_Up);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_npx9;
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_KP_Page_Down);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_npx3;
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_KP_End);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_npx1;
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_KP_Insert);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_npx0;
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_KP_Delete);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_npx10;
    
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_KP_Enter);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_Enter;
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_KP_Multiply);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_NumpadMultiply;
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_KP_Add);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_NumpadAdd;
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_KP_Subtract);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_NumpadSubtract;
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_KP_Separator);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_NumpadPeriod;
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_KP_Divide);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_NumpadDivide;
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_F1);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_F1;
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_F2);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_F2;
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_F3);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_F3;
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_F4);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_F4;
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_F5);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_F5;
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_F6);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_F6;
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_F7);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_F7;
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_F8);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_F8;
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_F9);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_F9;
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_F10);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_F10;
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_F11);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_F11;
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_F12);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_F12;
    
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_Num_Lock);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_NumLock;
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_Scroll_Lock);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_ScrollLock;
    
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_semicolon);
    if(keycode)if(keycode[1]>0)local_k_map[(uint8_t)max(min(keycode[1],0xff),0)]=Key_SemiColon;
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_equal);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_Equal;
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_comma);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_Comma;
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_minus);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_Dash;
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_period);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_Period;
    ...
    if(keycode)if(keycode[1]>0)local_k_map[(uint8_t)max(min(keycode[1],0xff),0)]=Key_ForwardSlash;
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_grave);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_GraveAccent;
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_bracketleft);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_OpenBracket;
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_backslash);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_BackSlash;
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_bracketright);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_CloseBraket;
    keycode=xcb_key_symbols_get_keycode(keySymbols, XK_apostrophe);
    if(keycode)local_k_map[(uint8_t)max(min(keycode[0],0xff),0)]=Key_SingleQuote;
